...
const RecentProjects = () => {
  ...
  useEffect(() => {
    setHydrated(true); // Mark component as hydrated once on the client
  }, []);
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x24 gap-y8 mt-10">
        {projects.map((item) => (
          ...
          >
            ...
            >
              <div className="relative flex items-center justify-center sm:w-[520px] sm:h-[40vh] h-[30vh] w-[80vw] overflow-hidden mb-10">
                <div
